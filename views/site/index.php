...
foreach ($posts as $post) {
    ...
    if (!Yii::$app->user->isGuest) {
        echo Html::a('Оставить комментарий', ['post', 'id' => $post->id], ['class' => 'btn btn-primary ']);
    }
    ...
    foreach ($comments as $comment) {
        ...
        echo "<div class='card ml-5'><div class='card-body'>" .
            ...
            "</div><div class='card-footer text-muted'>" . date_format(date_create($comment->time), "j F Y H:i") . "</div></div>";
    }
}
